CREATE DATABASE IF NOT EXISTS `bakonglinkedaccount`;
...
CREATE TABLE  `tbltransaction` (
  ...
  `datetimeinmilisecond` varchar(256) DEFAULT NULL,
  `transDate` varchar(256) DEFAULT NULL,
  PRIMARY KEY (`refNumber`)
)ENGINE=InnoDB DEFAULT CHARSET=utf8;


DROP TABLE IF EXISTS `tblencryption`;
CREATE TABLE `tblencryption`(
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `account` varchar(50) unique NOT NULL,
  `encryptData` varchar(256) DEFAULT NULL,
  PRIMARY KEY(`id`)
)ENGINE=InnoDB DEFAULT CHARSET=utf8;
